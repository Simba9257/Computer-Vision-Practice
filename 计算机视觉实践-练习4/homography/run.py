...
# cv_desk = img_as_float(io.imread('./imag/back.jpg'))
# cv_desk_gray = rgb2gray(cv_desk)
# cv_cover1 = img_as_float(io.imread('./imag/book1.jpg'))
# cv_cover = rgb2gray(cv_cover1)
# hp_cover = img_as_float(io.imread('./imag/book2.jpg'))

cv_desk = img_as_float(io.imread('./img/back.jpg'))
cv_desk_gray = rgb2gray(cv_desk)
cv_cover1 = img_as_float(io.imread('./img/pad1.jpg'))
cv_cover = rgb2gray(cv_cover1)
hp_cover = img_as_float(io.imread('./img/pad2.jpg'))
...
# plt.savefig(r"./imag/result.jpg")
plt.savefig(r"./img/result.jpg")
plt.show()
# io.imwrite('img_res.jpg', composite_img)